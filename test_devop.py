...
def test_square_root():
    ...
    assert square_root(5) != 2.0
    assert square_root(13) != 4.0

def test_factorial():
    assert factorial(4) == 24
    assert factorial(0) == 1
    assert factorial(1) == 1
    assert factorial(3) != 16
...
def test_natural_log():
    ...
    assert natural_log(11) != 3.0
    assert natural_log(12) != 5.0
...
def test_power():
    ...
    assert power(-2,3) == -8.0
    assert power(0, 5) != 5.0
    assert power(-2, 6) != -8.0
